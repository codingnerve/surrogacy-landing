...
export default function Home() {
  return (
    <main className="min-h-screen">
      ...
      {/* Footer */}
      <footer className="bg-slate-900 text-white py-8 md:py-16 px-4 md:px-12 lg:px-24 border-t border-slate-800">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6 md:gap-8">
          <div className="text-center md:text-left">
            <h3 className="text-xl md:text-2xl font-bold mb-2 text-white">Ginix Fertility</h3>
          ...
          <p className="text-slate-500 text-[9px] md:text-sm text-center md:text-left">© 2024 SurrogacyCare Program. All rights reserved.</p>
        </div>
      </footer>
