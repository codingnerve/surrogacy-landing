...
const Hero = () => {
    return (
        <section className="relative overflow-hidden bg-linear-to-br from-red-50/40 via-white to-red-50/30 lg:min-h-[80vh] flex items-center py-7 lg:py-0">
            ...
            <div className="max-w-7xl mx-auto w-full px-3 sm:px-4 md:px-12 lg:px-24">

                {/* Mobile layout: stacked — text, then form */}
                <div className="flex flex-col gap-5 lg:hidden">
                    ...
                    >
                        <span className="inline-block px-3 py-1.5 mb-3 text-[9px] font-black tracking-[0.12em] text-primary uppercase bg-red-50 border border-primary/10 rounded-full shadow-sm">
                        ...
                        <div className="flex flex-wrap justify-center gap-3">
                            <div className="flex items-center gap-1.5 text-xs font-medium text-text-main">
                                <ShieldCheck className="w-4 h-4 text-primary" /> Ethical Care
                            </div>
                            <div className="flex items-center gap-1.5 text-xs font-medium text-text-main">
                                <Globe className="w-4 h-4 text-primary" /> Global Parents
                            </div>
                            <div className="flex items-center gap-1.5 text-xs font-medium text-text-main">
                                <Scale className="w-4 h-4 text-primary" /> Legal Support
                            </div>
                        </div>
                    </motion.div>

                    {/* FORM — inline, no absolute positioning */}
                    <motion.div
                ...
                {/* Desktop layout: side-by-side with floating form over image */}
                <div className="hidden lg:grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <motion.div
                        ...
                        className="text-left"
                    >
                        <span className="inline-block px-3 py-1.5 mb-6 text-xs font-black tracking-[0.12em] text-primary uppercase bg-red-50 border border-primary/10 rounded-full shadow-sm">
                            Altruistic Surrogacy Program in Delhi NCR
                        </span>
                        ...
                        <div className="flex flex-wrap gap-5">
                            <div className="flex items-center gap-2 text-sm font-medium text-text-main">
                                <ShieldCheck className="w-5 h-5 text-primary" /> Ethical Care
                            </div>
                            <div className="flex items-center gap-2 text-sm font-medium text-text-main">
                                <Globe className="w-5 h-5 text-primary" /> Global Parents
                            </div>
                            <div className="flex items-center gap-2 text-sm font-medium text-text-main">
                                <Scale className="w-5 h-5 text-primary" /> Legal Support
                            </div>
                        </div>
                    </motion.div>
                    ...
                    <motion.div
                        ...
                        className="relative w-full max-w-xl mx-auto pb-16"
                    >
